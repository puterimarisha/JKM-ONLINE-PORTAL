...
<tr><td> <a href="http://localhost/RELATIES%20ONLINE%20PORTAL/indexscanner.php?eventID=<?php echo $eventID; ?>" ><input type="submit" value="Attend"></a> <a href="http://localhost/RELATIES%20ONLINE%20PORTAL/cancel.php?eventID=<?php echo $eventID; ?>" ><input type="submit" value="Cancel"></a><br>
</td></tr>
</div>
</table>
<?php
