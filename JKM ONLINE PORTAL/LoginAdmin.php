...
<h2> ADMIN LOGIN</h2>
<hr>
<label for="usrname">Username</label><br> <input type="text" name="Ausrname" id="Ausrname" placeholder="Eg: CC18151" required><br>
<label for="passWord">Password</label><br> <input type="password" name="Apsw" id="Apsw" placeholder="Eg: *********" required><br>
